...
if (g) {
  ...
  var user,               // Option user database
    ...
    folder_links,        // Option path folder models 
  ...
  //Folder routes
  folder_routes = cli.flags.r || cli.flags.routes;
  if (folder_routes === true || folder_routes == "true") {
    folder_routes = concat(process.cwd(), "routes"); // Method concat: see configs/route.js
  }
...
function info() {
  ...
  console.log("Routes      :", color((folder_routes || "Not generate"), "green"));
  console.log("Links      :", color((folder_links || "Not generate"), "green"));
